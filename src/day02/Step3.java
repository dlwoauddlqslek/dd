...
public class Step3 {
  public static void main(String[] args) {
    ...
    System.out.println(y==-5 || y<0); //false || ture -> true
    System.out.println(!(x>=20)); // !false -> true

    // 5. 복합대입연산자
      // = 대입연산자 : 오른족 값을 왼족에 대입한다.
    int z = 30;
      // += -= *= /= %=: 오른쪽 값을 왼쪽값과 연산후 결과를 왼족에 대입
    z+=1;
    z=z+1;
    ...
    // 7. 삼항연사자: 조건? 참 : 거짓, 조건1? 참1: 조건2? 참2: 거짓
